...
export default function NewsSection({ featuredNews, recentNews }: NewsSectionProps) {
  return (
      ...
      <div className="container-custom">
        ...
        {featuredNews && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start mb-16">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="w-full aspect-[16/9] lg:aspect-[4/2.5] rounded-[20px] overflow-hidden bg-[#e6f4ec] flex items-center justify-center relative group shadow-sm"
            >
               <img 
            ...
            >
              ...
              <div className="flex items-center text-brand-green gap-2 py-1">
                ...
                <span className="font-medium text-[15px]">{featuredNews.date}</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {recentNews.map((item, index) => (
            ...
            >
              {/* Card Image */}
              <div className="w-full aspect-[4/2.5] rounded-[20px] overflow-hidden bg-gray-100 flex items-center justify-center relative mb-5 shadow-sm">
                <img 
                  src={item.image} 
                  alt={item.title} 
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
